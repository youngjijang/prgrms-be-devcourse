package com.example.kdtspringjpa.order.converter;

import com.example.kdtspringjpa.domain.*;
...
public class OrderConverter {
    ...
    private Member convertMember(MemberDto memberDto) {
        ...
        //member.setOrders(); -> order 안에서 연관관계 편의성을 위한 메소드가 있기때문에 생략해줘도된다. 자동으로 세팅됨
        return member;
    }
    ...
    public OrderDto convertOrderDto (Order order) {
        return OrderDto.builder() //builder
                .uuid(order.getUuid())
                .memo(order.getMemo())
